...
{
    /// <inheritdoc />
    public partial class addQuizAndQuestionToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Quiz",
                columns: new[] { "Id", "SectionId", "Title" },
                values: new object[] { 1, 2, "Quiz matematyka test" });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "Answer1", "Answer2", "Answer3", "Answer4", "IsCorrect", "QuestionText", "QuizId" },
                values: new object[] { 1, "24", "34", "44", "54", 1, "Ile to 22 + 2?", 1 });
